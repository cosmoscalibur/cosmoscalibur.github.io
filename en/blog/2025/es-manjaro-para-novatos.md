...
I've been using Manjaro for 7 months now, and I've become passionate about it. I like having new features quickly, without sacrificing stability (which happened to me in my attempts with Arch Linux), its *hardware* and *Linux kernels* manager seem like very good utilities to me. In addition, {program}`pamac` is a very useful tool to manage packages in Manjaro, much more friendly than {program}`pacman` from Arch Linux, and with some similarity to {program}`apt` from Debian/Ubuntu. Manjaro's own documentation, added to the excellent Arch Linux documentation, make it a very easy distribution to use, and I will dare to say, that this ease is extended for newbies.
...
If you decide to use Manjaro and being a newbie, with even more reason the recommended package management is with {program}`pamac` instead of {program}`pacman`. It is more friendly in commands and you can remember them easier, and with the help of KDE Discover you can even manage the installation of Flatpak packages graphically.

The forum and resources in general of Manjaro are very good, many suitable for any level of user. And without a doubt, you will also find collaboration on the network to support you on how to continue this path when migrating from Windows to Linux, not only to this distribution but to others, in your [distrohopping](/en/blog/2024/distrohopping-cambiar-de-distribuci%C3%B3n-linux-y-no-morir-en-el-intento.md) adventure. And I remain attentive to support this path.

## Recommendations

I have already published on other occasions topics related to Manjaro, so I recommend you take a look:

- [](/en/blog/2024/distrohopping-cambiar-de-distribuci%C3%B3n-linux-y-no-morir-en-el-intento.md)
- [](/en/blog/2024/que-hacer-despues-de-instalar-manjaro.md)
- [](/en/blog/2024/problemas-de-conexion-wifi-en-linux.md)
- [](/en/blog/2024/problema-de-wayland-y-graficos-hibridos-en-linux.md)
- [](/en/blog/2025/montar-disco-en-linux-y-error-de-volumen-sucio.md)
