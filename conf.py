...
SITE_URL = "https://www.cosmoscalibur.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://www.cosmoscalibur.com/" # "https://cosmoscalibur.github.io/" # Mala idea porque al ajustar adecuadamente es reconocido en fb como movido permanentemente
BLOG_EMAIL = "cosmoscalibur&#64;gmail.com"
BLOG_DESCRIPTION = {"es": "Blog de ciencia, tecnología, cultura y literatura. Unir estos mundos no solo en un sitio sino en una historia.",
                    "en": "Science, tech and entertainment blog."}  # (translatable)
...
FILTERS = {
   ...
   ".png": ["filters.optipng"],
   # ".js": ["filters.yui_compressor"], # all local failed.
...
TWITTER_CARD = {
    ...
    'site': 'cosmoscalibur',         # twitter nick for the website
    'creator': 'eyvillegasp',     # Username for the content creator / author.
}
