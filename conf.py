...
# Blog Cosmoscalibur build configuration file, created by
# `ablog start` on Sun Apr 28 16:19:07 2024.
#
...
blog_authors = {
    "Edward Villegas-Pulgarin": ("Edward Villegas-Pulgarin", None),
}
...
htmlhelp_basename = "BlogCosmoscaliburdoc"
